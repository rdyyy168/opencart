...
class __TwigTemplate_6affcee7c09eb87a1ec32406c937aaa0 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["zones"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["zone"]) {
              ...
              <td class=\"text-start\">";
                ...
                ";
                // line 20
                if (twig_get_attribute($this->env, $this->source, $context["zone"], "status", [], "any", false, false, false, 20)) {
                    // line 21
              ...
              <td class=\"text-start\">";
                // line 26
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "name", [], "any", false, false, false, 26);
                echo "</td>
              <td class=\"text-start\">";
                // line 27
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "code", [], "any", false, false, false, 27);
                echo "</td>
              <td class=\"text-end\"><a href=\"";
                // line 28
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "edit", [], "any", false, false, false, 28);
...
";
    ...
    {
        return new Source("", "admin/view/template/localisation/zone_list.twig", "C:\\xampp\\htdocs\\opencart\\admin\\view\\template\\localisation\\zone_list.twig");
    }
}
